...
class DfsTest(Realm):
    ...
    def main_logic(self):
        ...
        if self.bandwidth == "20":
            ...
            self.centre_freq = {"52": "5260000", "56": "5280000", "60": "5300000", "64": "5320000", "100": "5500000",
            ...
            self.centre_freq = {"52": "5270000", "56": "5270000", "60": "5310000", "64": "5310000", "100": "5510000",
            ...
            self.centre_freq = {"52": "5290000", "56": "5290000", "60": "5290000", "64": "5290000", "100": "5530000",
            ...
            self.centre_freq = {"100": "5570000", "104": "5570000", "108": "5570000", "112": "5570000", "116": "5570000",
        ...
        for fcc in self.fcctypes:
            for frq in new_list:
                for tria in range(self.trials):
                    ...
                    diff = (int(frq) - int(self.centre_freq[self.channel])) / 1000
                    val = str(diff)
                    main_dict[fcc][frq][var_1]["Freq_offset"] = val
                    # if self.centre_freq[self.channel] < frq:
                    #     diff = int(self.centre_freq[self.channel]) - int(frq)
                    #     val = str(diff)
                    #     main_dict[fcc][frq][var_1]["Freq_offset"] = val
                    # else:
                    #     diff = int(self.centre_freq[self.channel]) - int(frq)
                    ...
                    self.start_sniffer(radio_channel=self.channel, radio=self.sniff_radio,
                                       test_name="dfs_csa_ch_" + str(self.channel) + "_" + str(int(int(frq)/1000)) + "MHz_")
    ...
    def run(self):
        print("Cleaning up the existing stations & cross-connections...")
        self.precleanup()
        print(self.fcctypes)
    ...
    def generate_report(self, test_duration="1:26:07", main_dict=None):
        ...
        report = lf_report_pdf.lf_report(_path="", _results_dir_name="Detection Bandwidth Test", _output_html="dbt.html",
                                         _output_pdf="dbt.pdf")
        ...
        for fcc in self.fcctypes:
            ...
            for i in main_dict[fcc]:
                ...
                val = (int(i) - int(self.centre_freq[self.channel])) / 1000
                print(val)
