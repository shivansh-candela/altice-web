...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_40mhz_all_channels_single_client_download_1gbps, pytest.mark.twog, pytest.mark.udp]
...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_open_ch1_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
        ...
        if station:
            ...
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="RVR_Channel_1_40_Mhz_Udp_Twog_Mode",
    ...
    @pytest.mark.udp_download
    def test_client_open_ch6_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
    ...
    @pytest.mark.udp_download
    def test_client_open_ch11_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
