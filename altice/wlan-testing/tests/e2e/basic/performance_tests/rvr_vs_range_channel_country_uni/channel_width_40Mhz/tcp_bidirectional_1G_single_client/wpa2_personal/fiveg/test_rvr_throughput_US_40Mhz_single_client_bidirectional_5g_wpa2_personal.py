...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_wpa2_40mhz_all_channels_single_client_bidirectional_1gbps,
              pytest.mark.rate_vs_range_throughput_wpa2_40mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg, pytest.mark.tcp]
...
class TestCountryUS40Mhz5G(object):
    ...
    @pytest.mark.fortyMhz
    @pytest.mark.fiveg
    @pytest.mark.channel_36
    @pytest.mark.tcp_bidirectional
    
    
    def test_client_wpa2_ch36_40Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectional_Throughput_TCP_40Mhz_wpa2_5g_Test",
                                               attachment_type="PDF")
    ...
    def test_client_wpa2_ch149_40Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
