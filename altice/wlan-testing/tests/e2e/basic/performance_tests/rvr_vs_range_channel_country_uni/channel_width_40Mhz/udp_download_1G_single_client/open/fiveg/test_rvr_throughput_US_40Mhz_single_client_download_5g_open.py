...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_40mhz_all_channels_single_client_download_1gbps, pytest.mark.fiveg, pytest.mark.udp]
...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_open_ch36_40Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
                                                                  test_cases, testbed, al_1, get_configuration,
                                                                  create_lanforge_chamberview_dut, get_attenuators):
        """
           pytest -m "country_code and fourtyMhz and open and fiveg and channel149"
        """
    ...
    @pytest.mark.udp_download
    def test_client_open_ch149_40Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
