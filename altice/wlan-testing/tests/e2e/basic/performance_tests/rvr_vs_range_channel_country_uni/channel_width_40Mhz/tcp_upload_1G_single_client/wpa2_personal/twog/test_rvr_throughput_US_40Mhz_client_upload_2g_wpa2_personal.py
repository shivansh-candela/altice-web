...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_wpa2_40mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog, pytest.mark.tcp]
...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_wpa2_ch1_40Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
                                                                  test_cases, testbed, al_1, get_configuration,
                                                                  create_lanforge_chamberview_dut, get_attenuators):
        """
           pytest -m "country_code and fourtyMhz and wpa2 and twog and channel149"
        """
        ...
        if station:
            ...
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_1_40_Mhz_Twog_Mode",
    ...
    @pytest.mark.tcp_upload
    def test_client_wpa2_ch6_40Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
        ...
        if station:
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_6_40_Mhz_Twog_Mode",
                                        vlan_id=vlan, dut_name=lf_tools.dut_name, raw_lines=val, ssid_channel=channel)
            report_name = rvr_o.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            print("report name ", report_name)
            entries = os.listdir("../reports/" + report_name + '/')
    ...
    @pytest.mark.tcp_upload
    def test_client_wpa2_ch11_40Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
        ...
        if station:
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_11_40_Mhz_Twog_Mode",
                                        vlan_id=vlan, dut_name=lf_tools.dut_name, raw_lines=val, ssid_channel=channel)
            report_name = rvr_o.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            print("report name ", report_name)
            entries = os.listdir("../reports/" + report_name + '/')
