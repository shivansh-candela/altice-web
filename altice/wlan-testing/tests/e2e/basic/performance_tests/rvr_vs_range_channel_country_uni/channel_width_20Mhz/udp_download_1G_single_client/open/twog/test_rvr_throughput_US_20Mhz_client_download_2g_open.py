...
class TestCountryUS20Mhz2G(object):
    ...
    def test_client_open_ch1_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_download
    def test_client_open_ch6_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
    ...
    @pytest.mark.udp_download
    def test_client_open_ch11_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
