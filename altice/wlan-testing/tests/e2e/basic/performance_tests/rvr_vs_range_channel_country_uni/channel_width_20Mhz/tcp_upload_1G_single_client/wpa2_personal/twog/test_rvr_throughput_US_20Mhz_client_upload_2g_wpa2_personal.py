...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_wpa2_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog, pytest.mark.tcp]
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_wpa2_ch1_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
        ...
        if station:
            ...
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_1_20_Mhz_Twog_Mode",
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_Upload_Throughput_TCP_2g_Test",
                                               attachment_type="PDF")
    ...
    @pytest.mark.tcp_upload
    def test_client_wpa2_ch6_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
        ...
        if station:
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_6_20_Mhz_Twog_Mode",
                                        vlan_id=vlan, dut_name=lf_tools.dut_name, raw_lines=val, ssid_channel=channel)
            report_name = rvr_o.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            print("report name ", report_name)
            entries = os.listdir("../reports/" + report_name + '/')
    ...
    @pytest.mark.tcp_upload
    def test_client_wpa2_ch11_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
        ...
        if station:
            rvr_o = lf_test.ratevsrange(station_name=station_names_twog, mode=mode, download_rate="100%",
                                        duration='60000',
                                        instance_name="Mode_RVR_Channel_11_20_Mhz_Twog_Mode",
                                        vlan_id=vlan, dut_name=lf_tools.dut_name, raw_lines=val, ssid_channel=channel)
            report_name = rvr_o.report_name[0]['LAST']["response"].split(":::")[1].split("/")[-1]
            print("report name ", report_name)
            entries = os.listdir("../reports/" + report_name + '/')
