...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_20mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.twog]
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_wpa2_chn1_20Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_Download_Throughput_TCP_5g_Test",
                                               attachment_type="PDF")
    ...
    @pytest.mark.tcp_download
    def test_client_wpa2_chn6_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
    ...
    @pytest.mark.tcp_download
    def test_client_wpa2_chn11_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
