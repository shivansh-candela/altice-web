...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.fiveg, pytest.mark.udp]
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_open_ch36_20Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_upload
    def test_client_open_ch149_20Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
