...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_wpa2_20mhz_all_channels_single_client_bidirectional_1gbps,
              pytest.mark.rate_vs_range_throughput_wpa2_20mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.twog, pytest.mark.tcp]
...
class TestCountryUS20Mhz2G(object):
    ...
    def test_client_wpa2_ch1_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectiona;_Throughput_TCP_20Mhz_wpa2_2g_Test",
                                               attachment_type="PDF")
                        ...
                        if os.path.exists(pdf):
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectional_Throughput_TCP_20Mhz_wpa2_2g_Test",
                                               attachment_type="PDF")
                        allure.attach(name="FAILED:Throughput Results:", body=str(
                            "Actual throughput:"))
                        assert True
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_wpa2_ch6_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
                ...
                if str(kpi_val) == "empty":
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            result["result"] = "FAIL"
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectional_Throughput_TCP_2g_Test",
                                               attachment_type="PDF")
                        allure.attach(name="FAILED:Throughput Results:", body=str(
                            "Actual throughput:"))
                        assert False, "Test failed due to lesser value"
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_wpa2_ch11_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut,get_attenuators):
