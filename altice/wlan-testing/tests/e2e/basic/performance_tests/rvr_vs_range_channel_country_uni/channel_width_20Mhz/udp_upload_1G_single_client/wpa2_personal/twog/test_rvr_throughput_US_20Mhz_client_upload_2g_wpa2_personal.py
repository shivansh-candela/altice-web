...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_wpa2_20mhz_all_channels_single_client_upload_1gbps,
              pytest.mark.rate_vs_range_throughput_wpa2_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog, pytest.mark.udp]
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_wpa2_ch1_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_upload
    def test_client_wpa2_ch6_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
    ...
    @pytest.mark.udp_upload
    def test_client_wpa2_ch11_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
