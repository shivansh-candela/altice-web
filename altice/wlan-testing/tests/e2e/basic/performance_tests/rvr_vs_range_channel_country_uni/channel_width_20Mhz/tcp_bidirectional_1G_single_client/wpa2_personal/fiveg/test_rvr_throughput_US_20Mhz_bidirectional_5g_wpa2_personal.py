...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              pytest.mark.bandwidth_20mhz, pytest.mark.al, pytest.mark.tcp,
              pytest.mark.bidirectional, pytest.mark.tcp_bidirectional, pytest.mark.rate_vs_range,
              pytest.mark.throughput_wpa2_20mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg]
...
class TestCountryUS20Mhz5G(object):
    ...
    @pytest.mark.sg_1234567
    
    def test_client_wpa2_chn36_20Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
        ...
        if station:
            ...
            rvr_o = lf_test.ratevsrange(station_name=station_names_fiveg, mode=mode, download_rate="100%", upload_rate ="100%",
                                        duration='60000',
                                        instance_name="MODE_RVR_FIVEG_mod",
                    ...
                    if "FAIL" in pass_fail:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectional_Throughput_TCP_20Mhz_wpa2_5g_Test",
                                               attachment_type="PDF")
