...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog, pytest.mark.tcp]
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_open_ch1_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.tcp_upload
    def test_client_open_ch6_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_twog, lf_tools,
    ...
    @pytest.mark.tcp_upload
    def test_client_open_ch11_20Mhz_US_2g_tcp_upload(self, instantiate_profile, get_lf_logs,
                                                            lf_test, update_report,
                                                            station_names_twog, lf_tools,
                                                            test_cases, testbed, al_1, get_configuration,
                                                            create_lanforge_chamberview_dut, get_attenuators):
