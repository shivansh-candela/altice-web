...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_80mhz_all_channels_single_client_download_1gbps, pytest.mark.fiveg, pytest.mark.tcp]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_open_ch36_80Mhz_US_5g_tcp_download(self, instantiate_profile, get_lf_logs,
                    ...
                    if len(failed_throughput) >= 1:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_download_Throughput_TCP_Test",
                                               attachment_type="PDF")
    ...
    @pytest.mark.tcp_download
    def test_client_open_ch149_80Mhz_US_5g_tcp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
                ...
                if str(kpi_val) == "empty":
                    ...
                    if len(failed_throughput) >= 1:
                        ...
                        if os.path.exists(pdf):
                            result["result"] = "FAIL"
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_download_Throughput_TCP_2g_Test",
                                               attachment_type="PDF")
                        allure.attach(name="FAILED:Throughput Results: ", body=str(
                            "Failed Throughputs are: " + str(failed_throughput)) + "Passed Throughputs: " + str(
                            passed_throughput))
