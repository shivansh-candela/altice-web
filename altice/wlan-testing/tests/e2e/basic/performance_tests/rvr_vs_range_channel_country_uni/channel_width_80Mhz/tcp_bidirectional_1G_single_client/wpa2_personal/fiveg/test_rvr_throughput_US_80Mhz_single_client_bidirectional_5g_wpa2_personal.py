...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_wpa2_80mhz_all_channels_single_client_bidirectional_1gbps,
              pytest.mark.rate_vs_range_throughput_wpa2_80mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg, pytest.mark.tcp]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_wpa2_ch36_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                    ...
                    if len(failed_throughput) >= 1:
                        ...
                        if os.path.exists(pdf):
                            ...
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_bidirectional_Throughput_TCP_80Mhz_wpa2_Test",
                                               attachment_type="PDF")
    ...
    def test_client_wpa2_ch149_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
