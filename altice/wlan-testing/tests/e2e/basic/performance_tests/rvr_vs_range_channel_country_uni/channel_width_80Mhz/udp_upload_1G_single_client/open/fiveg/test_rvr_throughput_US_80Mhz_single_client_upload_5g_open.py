...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_throughput_open_80mhz_all_channels_single_client_upload_1gbps, pytest.mark.fiveg, pytest.mark.udp]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_open_ch36_80Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
        ...
        val = [['modes: 802.11an-AX'], ['pkts: MTU'], ['directions: DUT Receive'], ['traffic_types:UDP'],
    ...
    @pytest.mark.udp_upload
    def test_client_open_ch149_80Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
