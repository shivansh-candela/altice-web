...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.rate_vs_range_wpa2_80mhz_all_channels_single_client_download_1gbps,
              pytest.mark.rate_vs_range_throughput_wpa2_80mhz_all_channels_single_client_download_1gbps, pytest.mark.fiveg, pytest.mark.udp]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_wpa2_ch36_80Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_download
    def test_client_wpa2_ch149_80Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
                                                                  lf_test, update_report,
                                                                  station_names_fiveg, lf_tools,
            ...
            if kpi in entries:
                ...
                if str(kpi_val) == "empty":
                    ...
                    if len(failed_throughput) >= 1:
                        ...
                        if os.path.exists(pdf):
                            allure.attach.file(source=pdf,
                                               name="Rate_Vs_Range_1GBPS_Downoad_Throughput_UDP_Test",
                                               attachment_type="PDF")
                        allure.attach(name="Passed:Throughput Results:",
                                      body=str("Passed Throughputs are :" + str(passed_throughput)))
                        assert True
