...
class TestCountryUS20Mhz2g(object):
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_open_chn6_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_open_chn11_20Mhz_US_2g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and twentyMhz and open and fiveg and channel_11"
        """
        profile_data = setup_params_general["ssid_modes"]["open"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
