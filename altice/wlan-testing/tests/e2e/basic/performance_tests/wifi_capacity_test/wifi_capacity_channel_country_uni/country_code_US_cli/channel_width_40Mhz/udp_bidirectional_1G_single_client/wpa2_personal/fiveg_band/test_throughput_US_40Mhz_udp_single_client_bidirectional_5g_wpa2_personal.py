...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_40mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg,pytest.mark.udp,]
...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_nat_wpa2_chn36_40Mhz_US_5g_udp_bidirectional(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_bidirectional
    def test_client_nat_wpa2_chn149_40Mhz_US_5g_udp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
