...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.download, pytest.mark.tcp_bidirectional, pytest.mark.wifi_capacity_single_client,
              pytest.mark.wifi_capacity_open_80mhz_all_channels_single_client_bidirectional_1gbps,
              pytest.mark.throughput_open_80mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["5g"]["tcp"]["bd"]["80Mhz"]
}
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_nat_open_chn36_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_open_NAT_tcp_bd_5g", mode=mode, vlan_id=vlan,
        ...
        if expected_throughput < float(actual_throughput):
            ...
            if os.path.exists(pdf):
                allure.attach.file(source=pdf,
                                   name="WiFi_Capacity_1GBPS_Bidirectional_Throughput_TCP_5g_Test", attachment_type="PDF")
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_open_chn149_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
