...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.throughput_open_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.fiveg,pytest.mark.udp]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["5g"]["udp"]["ul"]["20Mhz"]
}
...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_nat_open_chn36_20Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_open_NAT_udp_ul_5g", mode=mode, vlan_id=vlan,
    ...
    @pytest.mark.udp_upload
    def test_client_nat_open_chn149_20Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
