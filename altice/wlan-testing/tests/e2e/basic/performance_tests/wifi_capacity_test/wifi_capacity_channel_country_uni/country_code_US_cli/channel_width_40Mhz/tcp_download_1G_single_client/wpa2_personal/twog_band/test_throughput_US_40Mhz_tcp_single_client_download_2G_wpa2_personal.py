...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["2g"]["tcp"]["dl"]["40Mhz"]
}
...
class TestCountryUS40Mhz2g(object):
    ...
    def test_client_nat_wpa2_chn1_40Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_wpa2_NAT_tcp_dl_2g", mode=mode, vlan_id=vlan,
    ...
    @pytest.mark.tcp_download
    def test_client_nat_wpa2_chn6_40Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration,  get_attenuators):
        """
    ...
    @pytest.mark.tcp_download
    def test_client_nat_wpa2_chn11_40Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration,  get_attenuators):
        """
