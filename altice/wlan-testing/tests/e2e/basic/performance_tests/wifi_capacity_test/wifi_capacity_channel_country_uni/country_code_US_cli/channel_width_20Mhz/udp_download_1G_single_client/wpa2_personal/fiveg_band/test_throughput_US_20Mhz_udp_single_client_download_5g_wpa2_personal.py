...
class TestCountryUS20Mhz5G(object):
    ...
    def test_client_nat_wpa2_chn36_20Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
        ...
        """
           pytest -m "country_code and udp_download and twentyMhz and wpa2 and fiveg and channel36"
        """
    ...
    def test_client_nat_wpa2_chn40_20Mhz_US_5g_udp_download(self, instantiate_profile, get_lf_logs,
                                                 ...
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and udp_download and twentyMhz and wpa2 and fiveg and channel40"
        """
        profile_data = setup_params_general["ssid_modes"]["wpa2_personal"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
