...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.throughput_open_40mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["5g"]["tcp"]["bd"]["40Mhz"]
}
...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_nat_open_chn36_40Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_open_chn149_40Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
