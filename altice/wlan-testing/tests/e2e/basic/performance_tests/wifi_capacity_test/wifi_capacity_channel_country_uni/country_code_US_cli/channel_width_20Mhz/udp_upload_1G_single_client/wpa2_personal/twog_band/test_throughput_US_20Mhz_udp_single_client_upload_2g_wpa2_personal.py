...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_20mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog,pytest.mark.udp]
...
class TestCountryUS20Mhz2G(object):
    ...
    def test_client_nat_wpa2_chn1_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
        ...
        """
           pytest -m "country_code and twentyMhz and wpa2 and fiveg and channel1"
        """
    ...
    @pytest.mark.udp_upload
    def test_client_nat_wpa2_chn6_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.udp_upload
    def test_client_nat_wpa2_chn11_20Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and twentyMhz and wpa2 and fiveg and channel11"
        """
        profile_data = setup_params_general["ssid_modes"]["wpa2_personal"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
