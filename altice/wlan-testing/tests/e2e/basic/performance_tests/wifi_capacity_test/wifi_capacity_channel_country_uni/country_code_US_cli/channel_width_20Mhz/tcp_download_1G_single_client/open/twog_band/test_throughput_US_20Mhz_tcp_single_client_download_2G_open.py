...
class TestCountryUS20Mhz2g(object):
    ...
    def test_client_nat_open_chn6_20Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
                                              ...
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and tcp_download and twentyMhz and open and twog and channel6"
        """
        profile_data = setup_params_general["ssid_modes"]["open"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
    ...
    def test_client_nat_open_chn11_20Mhz_US_2g_tcp_download(self, instantiate_profile, get_lf_logs,
                                              ...
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and tcp_download and twentyMhz and open and twog and channel11"
        """
        profile_data = setup_params_general["ssid_modes"]["open"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
