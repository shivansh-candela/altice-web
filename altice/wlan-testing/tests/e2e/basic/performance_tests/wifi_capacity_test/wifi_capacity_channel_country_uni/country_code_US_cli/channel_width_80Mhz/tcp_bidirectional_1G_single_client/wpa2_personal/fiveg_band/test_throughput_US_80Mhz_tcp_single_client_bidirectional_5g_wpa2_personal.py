...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_80mhz_all_channels_single_client_bidirectional_1gbps, pytest.mark.fiveg]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_nat_wpa2_chn36_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_wpa2_NAT_tcp_bd_5g", mode=mode, vlan_id=vlan,
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_wpa2_chn149_80Mhz_US_5g_tcp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
