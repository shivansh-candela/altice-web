...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              pytest.mark.bandwidth_80mhz, pytest.mark.al, pytest.mark.tcp, pytest.mark.wifi_capacity,
              pytest.mark.download, pytest.mark.tcp_download, pytest.mark.wifi_capacity_single_client,
              pytest.mark.wifi_capacity_open_80mhz_all_channels_single_client_download_1gbps,
              pytest.mark.throughput_open_80mhz_all_channels_single_client_download_1gbps, pytest.mark.fiveg]
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_nat_open_chn36_80Mhz_US_5g_download(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_open_NAT_tcp_dl_5g", mode=mode, vlan_id=vlan,
    ...
    @pytest.mark.download
    def test_client_nat_open_chn149_80Mhz_US_5g_download(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration):
        """
