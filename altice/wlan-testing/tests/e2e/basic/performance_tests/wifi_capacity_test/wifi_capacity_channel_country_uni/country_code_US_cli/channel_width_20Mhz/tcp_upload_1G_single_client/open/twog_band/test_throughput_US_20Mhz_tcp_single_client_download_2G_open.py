...
class TestCountryUS20Mhz2g(object):
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel2"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel3"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel4"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel5"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel7"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel8"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                           test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel9"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
    ...
    #                                            test_cases, testbed, al_1, get_configuration):
    #     """
    #        pytest -m "country_code and twentyMhz and open and twog and channel10"
    #     """
    #     profile_data = setup_params_general["ssid_modes"]["open"][0]
    #     ssid_name = profile_data["ssid_name"]
    #     security_key = profile_data["security_key"]
