...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_20mhz_all_channels_single_client_upload_1gbps]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["5g"]["tcp"]["ul"]["20Mhz"]
}
...
class TestCountryUS20Mhz2g(object):
    ...
    @pytest.mark.tcp_upload
    def test_client_nat_wpa2_chn6_20Mhz_US_2g_upload(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.tcp_upload
    def test_client_nat_wpa2_chn11_20Mhz_US_2g_upload(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
