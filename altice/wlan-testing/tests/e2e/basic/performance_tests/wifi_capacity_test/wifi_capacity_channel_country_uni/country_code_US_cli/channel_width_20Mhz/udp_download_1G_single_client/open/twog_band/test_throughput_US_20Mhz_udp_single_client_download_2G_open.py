...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.throughput_open_20mhz_all_channels_single_client_download_1gbps, pytest.mark.udp]
...
class TestCountryUS20Mhz2g(object):
    ...
    def test_client_nat_open_chn1_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_open_NAT_udp_dl_2g", mode=mode, vlan_id=vlan,
        ...
        if expected_throughput < float(actual_throughput):
            ...
            if os.path.exists(pdf):
                allure.attach.file(source=pdf,
                                   name="WiFi_Capacity_1GBPS_Download_Throughput_Testt_UDP_2g", attachment_type="PDF")
            assert True
        else:
            result["result"] = "FAIL"
            pdf = lf_tools.create_dynamic_pdf(report_name, get_configuration, result)
            ...
            if os.path.exists(pdf):
                allure.attach.file(source=pdf,
                                   name="WiFi_Capacity_1GBPS_Download_Throughput_Test_UDP_2g", attachment_type="PDF")
            assert False
    ...
    @pytest.mark.udp_download
    def test_client_nat_open_chn6_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.udp_download
    def test_client_nat_open_chn11_20Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
