...
class TestCountryUS40Mhz5G(object):
    ...
    def test_client_nat_open_chn36_40Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_upload
    def test_client_nat_open_chn149_40Mhz_US_5g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
