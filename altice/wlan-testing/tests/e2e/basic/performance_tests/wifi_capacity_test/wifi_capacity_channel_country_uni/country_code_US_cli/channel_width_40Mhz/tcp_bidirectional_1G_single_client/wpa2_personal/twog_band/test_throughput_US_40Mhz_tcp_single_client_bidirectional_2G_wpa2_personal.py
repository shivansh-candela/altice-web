...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_40mhz_all_channels_single_client_bidirectional_1gbps]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["2g"]["tcp"]["bd"]["40Mhz"]
}
...
class TestCountryUS40Mhz2g(object):
    ...
    def test_client_nat_wpa2_chn1_40Mhz_US_2g_tcp_Bidirectional(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_wpa2_chn6_40Mhz_US_2g_tcp_Bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.tcp_bidirectional
    def test_client_nat_wpa2_chn11_40Mhz_US_2g_tcp_Bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
