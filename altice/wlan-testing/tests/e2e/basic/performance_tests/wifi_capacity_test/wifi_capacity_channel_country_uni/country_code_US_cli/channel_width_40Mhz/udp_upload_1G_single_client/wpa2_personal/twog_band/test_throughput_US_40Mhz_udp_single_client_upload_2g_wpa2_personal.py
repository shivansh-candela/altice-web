...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_40mhz_all_channels_single_client_upload_1gbps, pytest.mark.twog,pytest.mark.udp]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["2g"]["udp"]["ul"]["40Mhz"]
}
...
class TestCountryUS40Mhz2G(object):
    ...
    def test_client_nat_wpa2_chn1_40Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_upload
    def test_client_nat_wpa2_chn6_40Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.udp_upload
    def test_client_nat_wpa2_chn11_40Mhz_US_2g_udp_upload(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_twog, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
