...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.open, pytest.mark.united_states,
              ...
              pytest.mark.throughput_open_80mhz_all_channels_single_client_biddirectional_1gbps, pytest.mark.fiveg,pytest.mark.udp,]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["5g"]["udp"]["bd"]["80Mhz"]
}
...
class TestCountryUS80Mhz5G(object):
    ...
    def test_client_nat_open_chn36_80Mhz_US_5g_udp_bidirectional(self, instantiate_profile, get_lf_logs,
    ...
    @pytest.mark.udp_bidirectional
    def test_client_nat_open_chn149_80Mhz_US_5g_udp_bidirectional(self, instantiate_profile, get_lf_logs,
                                                 lf_test, update_report,
                                                 station_names_fiveg, lf_tools,
                                                 test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
           pytest -m "country_code and eightyMhz and open and fiveg and channel_149"
        """
        profile_data = setup_params_general["ssid_modes"]["open"][0]
        ssid_name = profile_data["ssid_name"]
        security_key = profile_data["security_key"]
