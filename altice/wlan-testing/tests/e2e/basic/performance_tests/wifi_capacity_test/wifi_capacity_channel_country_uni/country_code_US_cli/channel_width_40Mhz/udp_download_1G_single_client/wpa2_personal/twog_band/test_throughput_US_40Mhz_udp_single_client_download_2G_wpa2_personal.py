...
pytestmark = [pytest.mark.country_code, pytest.mark.nat, pytest.mark.wpa2, pytest.mark.united_states,
              ...
              pytest.mark.throughput_wpa2_40mhz_all_channels_single_client_download_1gbps, pytest.mark.udp]
...
setup_params_general = {
    ...
    "radius": False,
    "expected-throughput": data["wc"]["2g"]["udp"]["dl"]["40Mhz"]
}
...
class TestCountryUS40Mhz2g(object):
    ...
    def test_client_nat_wpa2_chn1_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_client_wpa2_NAT_udp_dl_2g", mode=mode, vlan_id=vlan,
        ...
        if expected_throughput < float(actual_throughput):
            ...
            if os.path.exists(pdf):
                allure.attach.file(source=pdf,
                                   name="WiFi_Capacity_1GBPS_Download_Throughput_UDP_2g_Test", attachment_type="PDF")
    ...
    @pytest.mark.udp_download
    def test_client_nat_wpa2_chn6_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
    ...
    @pytest.mark.udp_download
    def test_client_nat_wpa2_chn11_40Mhz_US_2g_udp_download(self, instantiate_profile, get_lf_logs,
                                              lf_test, update_report,
                                              station_names_twog, lf_tools,
                                              test_cases, testbed, al_1, get_configuration, get_attenuators):
        """
