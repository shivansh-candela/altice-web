...
class StaConnect2(Realm):
    ...
    def setup(self, extra_securities=None):
        ...
        self.l3_udp_profile.side_a_min_bps = 1000000
        self.l3_udp_profile.side_b_min_bps = 1000000
        ...
        self.l3_tcp_profile.side_a_min_bps = 1000000
        self.l3_tcp_profile.side_b_min_bps = 1000000
