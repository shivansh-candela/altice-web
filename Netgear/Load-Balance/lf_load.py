...
def main():
    ...
    parser.add_argument('--bands', nargs="+", type=str,
                        help='select type of bands you want to perform the test on like 2.4G/5 LOW /5 HIGH',
                        default=['2.4G', '5G_low', '5G_high'])
    parser.add_argument('--add_attenuator', type=str, help="add the attenuator serial number on which erforming the test")
