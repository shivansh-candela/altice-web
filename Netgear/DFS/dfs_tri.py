...
def run():
    ...
    parser.add_argument('-i', '--i', type=str, help='AP ip')
    parser.add_argument('-u', '--u', type=str, help='credentials login/username')
    parser.add_argument('-p', '--p', type=str, help='credential password')
    parser.add_argument('-mgr', '--mgr', type=str, help='host name', default="localhost")
    parser.add_argument('-s', '--s', type=str, help='ssid for client')
    parser.add_argument('-pwd', '--pwd', type=str, help='password to connect to ssid', default='[BLANK]')
    parser.add_argument('-sec', '--sec', type=str, help='security', default='open')
    parser.add_argument('-rad', '--rad', type=str, help='radio at which client will be connected', default='wiphy0')
