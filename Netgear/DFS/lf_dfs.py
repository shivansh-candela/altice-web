...
class DFS_TEST:
    ...
    def monitor_station_before(self, host, ssid, passwd, security, radio):
        self.host = host
        self.ssid = ssid
        self.passwd = passwd
        self.security = security
    ...
    def monitor_station_(self, host, ssid, passwd, security, radio, channel, channel_before):
        self.host = host
        self.ssid = ssid
        self.passwd = passwd
        self.security = security
...
def run():
    ...
    for fcc in fcc_types:
        ...
        for channel_s in channel_values:
            ...
            # monitor channel
            channel_before = dfs.monitor_station_before(args.host, args.ssid, args.passwd, args.security, args.radio)
