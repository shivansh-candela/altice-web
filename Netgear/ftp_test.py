...
class ftp_test(LFCliBase):
    ...
    def set_values(self):
        ...
        if self.band == "5G":
            ...
            self.radio = ["wiphy1"]
            if self.file_size == "2MB":
                self.duration = self.convert_min_in_time(5)
            elif self.file_size == "500MB":
    ...
    def ftp_test_data(self, dict_data, pass_fail, bands, file_sizes, directions, num_stations):
...
def main():
    ...
    parser = LFCliBase.create_bare_argparse(prog="netgear-ftp", formatter_class=argparse.RawTextHelpFormatter,
    ...
    for band in args.bands:
        for direction in args.directions:
            for file_size in args.file_sizes:
                ...
                ftp_data[iteraration_num] = obj.ftp_test_data(dict_sta_name_time, pass_fail, args.bands,
                                                              args.file_sizes, args.directions, args.num_stations)
