"""
This script particularly checks for load balancing pass/ fail criteria according to channel utilization threshold and max client connections

cmd - sudo python3 test_23.py  -i 192.168.208.201 -u root  -p Netgear@123xzsawq@! -hst localhost -s Nikita -pwd [BLANK] -sec open -rad wiphy0 --client 22 --client5 30 --ch_threshold 70 --ch_threshold5 80
