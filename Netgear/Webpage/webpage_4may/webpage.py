...
how to run -
sudo  python3 lf_webpage.py --mgr 192.168.200.34 --upstream_port enp26s0 --num_stations 40 --security open --ssid loadbalance  --passwd [BLANK] --target_per_ten 1 --bands 5G 2.4G  --file_size 10Mb  --fiveg_radio wiphy0 --twog_radio wiphy0 --duration 2
