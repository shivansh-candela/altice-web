"""run-  python3 webpage_dl.py --mgr localhost --upstream_port eth1 --num_stations 40
  --security open --ssid TestAP-Jitendra --passwd [BLANK] --target_per_ten 1 --url 192.168.1.42/webpage.html  --file_size 20Mb
...
class HTTPDOWNLOAD(Realm):
    def __init__(self, lfclient_host, lfclient_port, upstream, num_sta, security, ssid, password, url,
                 target_per_ten, file_size, bands,start_id=0, _debug_on=False, _exit_on_error=False, _exit_on_fail=False):
