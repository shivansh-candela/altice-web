    ...
    def build_vap(self, channel, radio, ip_addr, netmask, gateway):
        ...
        if self.vap_list == "vap00":
            ...
            self.vap_profile.create(resource=1 ,radio=radio, channel=channel, up_=True, debug=False,
                                    suppress_related_commands_=True, use_radius=True, hs20_enable=False,use_ht40=False,create_bridge=False)
        elif self.vap_list == "vap01":
...
def main():
    ...
    for line in csv.DictReader(open('skyuk.csv')):
        ...
        for sta_name in station_list:
            if sta_name == name1:
                val = {'ssid': args.ssid1, 'security': args.security1, 'radio': args.sta_rad1,
                       ...
                       'ip_addr': "192.168.1.2", 'gateway': "192.168.1.1", 'vap_name': sta_vap}
            elif sta_name == name2:
                val = {'ssid': args.ssid2, 'security': args.security2, 'radio': args.sta_rad2,
                       ...
                       'ip_addr': "192.168.2.2", 'gateway': "192.168.2.1", 'vap_name': sta_vap2}
            elif sta_name == name3:
                val = {'ssid': args.ssid3, 'security': args.security3, 'radio': args.sta_rad3,
                       ...
                       'speed_a_min': int(speed3), 'speed_a_maax': int(speed3), 'speed_b_min': 0, 'speed_b_max': 0,
                       'ip_addr': "192.168.3.2", 'gateway': "192.168.3.1", 'vap_name': sta_vap3}
        ...
        station1 = ChannelSelectionTest(host=args.mgr, port=8080)
        station1.start_cx()
        time.sleep(120)
        print("AP reboot ")
    ...
    generate_report(final_data,
                    date,
                    expected_value=expected_channel,
