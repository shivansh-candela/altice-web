...
def test_steps():
    html = """
               ...
               <ul>
                    <li>In each test trial,create different loads on Channel 1,6,11 representing various real world environments.</li>
                    <li>Reboot the AP for each trial and check what channel the AP chooses.</li>
...
def bar_plot(ax, data, colors=None, total_width=0.8, single_width=1, legend=True):
    ...
    ax.set_title("Percentage distribution of expected and actual Channel allocation across 2.4GHz channels",fontsize=15)
    channels = [1, 2, 3]
