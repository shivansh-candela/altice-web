...
def main():
    ...
    parser.add_argument('--radios',help='provide hoe many radios test supports',default="6")
    ...
    parser.add_argument('--vap_rad3', help='vap3 radio',default="1.3.wiphy0")
    ...
    parser.add_argument('--sta_rad3', help='station radio for vap3, provide according to resources', default="1.3.wiphy1")
    ...
    parser.add_argument('--pswd', type=str, help='credential password', default='Lanforge12345!')
    ...
    for (a, b, c) in zip(ch1_list, ch6_list, ch11_list):
        ...
        if 'channel' in m:
            z = m.index('channel')
            #print(z)
            ap_channel_after = m[z + 1]
        print(ap_channel_after)
        # lst = ap_channel
        # x = lst[-2]
        # y = x[47:]
